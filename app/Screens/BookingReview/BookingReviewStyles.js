...
export default BookingReviewStyles = StyleSheet.create({
    titleCss:{
        padding: 5, flex: 1, color: Colors.black, fontSize: 13, fontFamily: fonts.PoppinsSemiBold, 
    },
    amountCss:{
        padding: 5, color: Colors.black, fontSize: 13, fontFamily: fonts.PoppinsRegular, 
    },
    safe_area_view: {
        flex: 1,
        backgroundColor: '#fff'
